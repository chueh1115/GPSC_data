...
GC1density<-2.1
GC1_br2<-0.3*2.1*1000/0.01/0.01/365*GC1_TOC/100 #=67.36
...
#TOC content (0.4-0.6 %) 
GC1_POCmin<-200*1000*0.4/100
GC1_POCmax<-800*1000*0.6/100

#3. min burial efficiency= burial rate (mgC/m2/d) / poc flux (mgC/m2/d)=%
GC1_br2/GC1_POCmin #=0.0842
GC1_br2/GC1_POCmax #=0.0140 ->use this data
GS1_br/GC1_POCmin #=0.1261
GS1_br/GC1_POCmax #=0.0210 ->use this data
